...
<div class="row">
	<div class="col-sm-6">
		<img  src="<?php echo "/lab05/".$prod["Picture"];?>" class="img-responsive" style="width:100%" alt="Image">
	</div>
...
<div class="row">
	<?php
		foreach($prods_relate as $item){
			?>
			<div class="col-sm-4">
			<a href="/lab05/product_detail.php?id=<?php echo $item["ProductID"]; ?>">
				<img  src="<?php echo "/lab05/".$item["Picture"];?>" class="img-responsive" style="width:100%" alt="Image">
			</a>
