<?php
require_once("/xampp/htdocs/lab06/Entities/product.class.php");
require_once("/xampp/htdocs/lab06/Entities/category.class.php");
?>
<?php
...
<div class="container text-center">
    ...
    <ul class = "list-group">
        ...
        foreach ($cates as $item){
            ...
            href=/lab06/list_product.php?cateid=".$item["CateID"].">".$item[CategoryName]."</a></li>";
        }?>
    </ul>
</div>
...
<div class="row">
	<div class="col-sm-6">
		<img  src="<?php echo "/lab06/".$prod["Picture"];?>" class="img-responsive" style="width:100%" alt="Image">
	</div>
...
<div class="row">
	<?php
		foreach($prods_relate as $item){
			?>
			<div class="col-sm-4">
			<a href="/lab06/product_detail.php?id=<?php echo $item["ProductID"]; ?>">
				<img  src="<?php echo "/lab06/".$item["Picture"];?>" class="img-responsive" style="width:100%" alt="Image">
			</a>
